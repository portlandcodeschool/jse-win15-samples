...
var Router = Backbone.Router.extend({
  ...
  checkers: function () {
    ...
    this.board = new BoardView({collection:this.game});
    this.board.render();
  }
});
...
/* EXERCISE:
add two routes to the application:
-- 'checkers' will play checkers, like the default route;
-- 'chess' will play chess
*/
