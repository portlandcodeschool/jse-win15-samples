// EXERCISE:
// The form contains an input for the todo "description" whose value
// is not yet used when adding new todo items.
// Upgrade the code below to make this input work the same way as todo title.
	...
	initialize: function () {
  	...
  	render: function () {
		...
		this.collection.models.forEach(function (item) {
			outputHtml += '<li><strong>' + item.get('title') + ':  </strong>' +'</li>';
		});
...
var todoInputView;
$(function () {
	todoInputView = new TodoInputView({collection: todos});
